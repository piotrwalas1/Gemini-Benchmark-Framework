...
Framework ten stanowi kompletne środowisko do obiektywnej i powtarzalnej oceny modeli językowych (LLM). Pozwala na porównanie wydajności modeli (**Gemini 2.0 Flash vs 2.5 Pro**) w oparciu o ustandaryzowany zestaw danych testowych (**Golden Dataset**). 
